...
var Car = /** @class */ (function () {
    ...
    Car.prototype.start = function () {
        console.log("The ".concat(this.year, " ").concat(this.make, " ").concat(this.model, " car is starting"));
    };
    return Car;
}());
var SUV = /** @class */ (function (_super) {
    ...
    SUV.prototype.toggleoffRoadCapability = function () {
        ...
        if (this.offRoadCapability) {
            console.log("".concat(this.make, " ").concat(this.model, " is now ready for off-road adventures"));
        }
        else {
            console.log("".concat(this.make, " ").concat(this.model, " is now set to regular road mode"));
        }
    };
    return SUV;
}(Car));
var mySUV = new SUV('Mahindra', 'Thar', 2024, false);
mySUV.start();
